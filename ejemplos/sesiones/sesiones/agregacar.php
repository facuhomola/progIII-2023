...
// la función extract toma las claves de una matriz asociativa y las convierte
// en nombres de variable, asignándoles a esas variables valores iguales a
// los que tenía asociados en la matriz. Es decir, convierte a $_GET['id'] en
// $id, sin que tengamos que tomarnos el trabajo de escribir $id=$_GET['id']; 
...
// temporalmente en el array superglobal $_SESSION['carro'], de manera
// que rescatamos los valores de dicho array y se los asignamos a la variable
// $carro, previa comprobación con isset de que $_SESSION['carro'] ya haya 
// sido definida.
...
// Ahora dentro de la sesión ($_SESSION['carro']) tenemos sólo los valores 
// que teníamos (si es que teníamos alguno) antes de ingresar a esta página y
// en la variable $carro tenemos esos mismos valores más el que acabamos de 
// sumar. De manera que tenemos que actualizar (reemplazar) la variable de 
// sesión por la variable $carro.

$_SESSION['carro']=$carro;
// Y volvemos a nuestro catálogo de artículos. La cadena SID representa al
// identificador de la sesión, que, dependiendo de la configuración del 
// servidor y de si el usuario tiene o no activadas las cookies puede no ser
// necesario pasarla por la url. 
